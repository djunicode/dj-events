...
class ReferralCountList extends React.Component {
  ...
  componentDidMount() {
    ...
    var config = {
      method: "get",
      url:
        "http://aryan123456.pythonanywhere.com/api/referral_table/" +
        event_id +
        "/",
      headers: {
  ...
  render() {
    return (
      <div style={{ background: "#1C2E4A" }}>
        ...
        <h4 style={{ color: "white" }}>Referral Counts</h4>
        <br></br>
        <div
          className="container"
          style={{
            background: "#4E586E",
            borderRadius: "28.3946px",
            boxShadow: "0px 5.67892px 5.67892px rgba(0, 0, 0, 0.25)",
          }}
        >
          <br></br>
          <div className="row">
